...
## Table of contents
- [Choosing the source database](#choosing-the-source-database)
- [Useful tool types](#useful-tool-types)
- [Common filters](#common-filters)
- [Severity vs. VPR](#severity-vs-vpr)
- [The SLA clock field](#the-sla-clock-field)
- [CISA KEV cross-reference](#cisa-kev-cross-reference)
- [Authentication / scan-health plugins](#authentication--scan-health-plugins)
